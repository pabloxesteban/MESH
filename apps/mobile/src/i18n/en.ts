...
export const en: Readonly<Record<TranslationKey, string>> = {
  ...
  'studio.ownDesign.size.hint':
    'However you\'d say it: "8x10cm", "small hand", "full forearm".',
  'studio.ownDesign.price.label': 'Price',
  ...
  'account.header.name.empty': 'No name',
  'account.header.livesIn': 'You live in {barrio}',
  'account.header.memberSince': 'Member since {fecha}',
  'account.header.editInStudio': 'Edit in Studio →',
  'account.header.completed': '{n} completed services',
  'account.header.completed.one': '1 completed service',
  'account.header.edit': 'Edit profile',
  'account.header.changePhoto': 'Change photo',
  'account.header.location.label': 'Location',
  'account.header.location.placeholder': 'Choose a location',
  'account.header.location.a11y': 'Location, {valor}',

  'account.notice.photo':
    "You haven't uploaded a profile photo yet. Without it, your card on Home has an empty space instead of your face.",
  'account.notice.photo.cta': 'Add a photo',
  'account.notice.location':
    "Your studio has no location set. Home sorts by distance; yours still shows up, always at the end.",
  'account.notice.location.cta': 'Add location',
  'account.notice.dismiss': 'Dismiss this notice',

  'account.recent.title': 'Recently saved',
  'account.recent.viewAll': 'See all →',
  'account.recent.itemA11y': 'Piece by {nombre}, saved',
  'account.recent.error': "We couldn't load what you saved.",

  'avatarPicker.title': 'Profile photo',
  'avatarPicker.source.gallery': 'Choose from gallery',
  'avatarPicker.source.camera': 'Take a photo',
  'avatarPicker.zoomIn': 'Zoom in',
  'avatarPicker.zoomOut': 'Zoom out',
  'avatarPicker.center': 'Center',
  'avatarPicker.confirm': 'Use this photo',
  'avatarPicker.permission.denied.title': 'No access to the camera',
  'avatarPicker.permission.denied.body':
    'You can choose a photo from your gallery instead.',
  'avatarPicker.upload.error': "Couldn't upload. Try again.",
  'avatarPicker.success': 'Done, we changed your photo',

  'settings.title': 'Settings',
  'settings.section.account': 'Account',
  'settings.section.preferences': 'Preferences',
  'settings.section.notifications': 'Notifications',
  'settings.section.privacy': 'Privacy and blocking',
  'settings.section.data': 'Data and legal',

  'collections.all.name': 'All',
  'collections.count': '{n} pieces',
  'collections.count.one': '1 piece',
  'collections.tile.a11y': '{nombre}, {cantidad}',
  'collections.new': '+ New collection',
  'collections.new.title': 'New collection',
  'collections.new.name.label': 'Name',
  'collections.new.create': 'Create',
  'collections.new.error': "We couldn't create the collection. Try again.",
  'collections.emptyCollection.title': "This collection doesn't have anything yet.",
  'collections.emptyCollection.addFromSaved': 'Add from what you saved',
  'collections.emptyCollection.keepExploring': 'Keep exploring',
  'collections.delete.entry': 'Delete collection',
  'collections.delete.confirm.title': 'Delete "{nombre}"?',
  'collections.delete.confirm.body':
    "This deletes the collection, not the pieces: they stay saved, loose, in All.",
  'collections.delete.confirm.submit': 'Delete collection',
  'collections.delete.toast': 'Deleted "{nombre}". The pieces stay in All.',
  'collections.item.addToCollection': 'Add to collection',
  'collections.membership.title': 'Add to collection',
  'collections.membership.done': 'Done',
  'collections.membership.error': "We couldn't save the change. Try again.",
  'collections.membership.noneYet': "You don't have any collections yet.",
  'collections.addMode.title': 'Choose what to add to "{nombre}"',
  'collections.addMode.done': 'Done',
  'collections.addMode.itemA11y.add': 'Add to {nombre}',
  'collections.addMode.itemA11y.remove': 'Already in {nombre}, remove',
